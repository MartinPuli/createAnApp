...
Use [`full-lifecycle-checklist.md`](full-lifecycle-checklist.md) as the stage ledger and re-open [`current-apple-requirements.md`](current-apple-requirements.md) before every upload or submission.
