...
Produce screen/state inventory, breakpoint rules, reusable components/tokens, accessibility annotations, paywall spec, visual QA matrix, screenshot storyboard, and prioritized findings with device-specific evidence. Read `references/visual-qa.md` for the review checklist.
