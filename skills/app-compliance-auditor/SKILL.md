...
Produce scope, data/SDK map, claim register, asset provenance gaps, subscription audit, policy/label reconciliation, security findings, jurisdiction questions, human/counsel handoffs, and a release verdict. Read `references/audit-matrix.md` for the minimum table.
