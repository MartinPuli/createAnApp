...
Read `references/validation-plan.md` for the output template and `references/validation-evidence.md` for evidence strength, cohort economics, and experiment discipline.
